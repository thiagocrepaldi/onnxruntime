...
#endif
  std::cout << " *************************************************************" << std::endl;
  std::cout << " ****************** c3p0 VitisAIExecutionProvider::AllocatorDefaultAlloc USE_MIMALLOC******************" << std::endl;
...
#endif
  std::cout << " *************************************************************" << std::endl;
  std::cout << " ****************** c3p0 VitisAIExecutionProvider::AllocatorDefaultFree USE_MIMALLOC ******************" << std::endl;
  std::cout << " *************************************************************" << std::endl << std::flush;
}
...
#endif
  std::cout << " *************************************************************" << std::endl;
  std::cout << " ****************** c3p0 VitisAIExecutionProvider::AllocatorDefaultAlloc NOT USE_MIMALLOC******************" << std::endl;
  std::cout << " *************************************************************" << std::endl << std::flush;
  return p;
}
...
#endif
  std::cout << " *************************************************************" << std::endl;
  std::cout << " ****************** c3p0 VitisAIExecutionProvider::AllocatorDefaultFree NOT USE_MIMALLOC******************" << std::endl;
  std::cout << " *************************************************************" << std::endl << std::flush;
}
